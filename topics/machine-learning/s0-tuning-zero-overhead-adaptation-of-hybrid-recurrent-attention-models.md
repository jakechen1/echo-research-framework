...
3. **Efficiency:** By avoiding the increased latency associated with methods like [[prefix-tuning|Prefix-tuning]] or per-step state-offset variants, S0 tuning maintains the high throughput required for modern [[large-language-models-for-outpatient-referral-problem-definition-benchmarking-an|Large Language Models]].