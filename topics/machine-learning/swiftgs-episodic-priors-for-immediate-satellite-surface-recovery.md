...
* **Decoupled Gaussian Primitives:** The system predicts geometry-radiation-decoupled [[Gaussian Splatting]] primitives to handle fine-grained details.
...
At inference, SwiftGS operates with zero-shot capabilities, allowing for nearly immediate surface recovery. This makes it a transformative tool for [[Remote Sensing]] in several critical sectors:
