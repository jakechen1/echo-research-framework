...
1.  **Encoding**: Transcriptomic profiles are encoded into a high-dimensional [[hilbert-space|Hilbert space]].
2.  **Transformation**: The model utilizes [[parameterized-quantum-circuits|parameterized quantum circuits]] to learn a unitary transformation.
