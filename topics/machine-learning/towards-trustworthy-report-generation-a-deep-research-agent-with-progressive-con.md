...
*   **[[deep-retrieval|Deep Retrieval]]**: The system performs intensive information fetching to find relevant, high-quality data.
*   **[[multi-hop-reasoning|Multi-hop Reasoning]]**: The agent connects disparate pieces of information across multiple steps to build a complex argument.
