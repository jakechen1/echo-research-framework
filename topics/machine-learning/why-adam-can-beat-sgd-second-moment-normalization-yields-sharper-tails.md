...
The study operates under the standard [[Bounded Variance Model]], a common assumption in [[Stochastic Optimization]]. The key contribution is the establishment of a formal theoretical separation in the high-probability convergence behaviors of the two algorithms. This separation is quantified through the dependence on the confidence parameter, $\delta$:
