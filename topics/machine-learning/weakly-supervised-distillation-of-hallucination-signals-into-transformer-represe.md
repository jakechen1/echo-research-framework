...
Using this approach, a dataset of 15,000 samples was constructed from [[squad-v2|SQuAD v2]], mapping the per-layer hidden states of [[llama-2-7b|LLaMA-2-7B]] to these automated hallucination labels.
