...
SBVS relies on the 3D structure of PHGDH, typically derived from X-ray crystallography or, more recently, high-resolution [[alphafold|AlphaFold]] models. The workflow follows a hierarchical pipeline:
...
*   **Ligand Library Generation:** Large-scale databases such as ZINC20, Enamine REAL, or Mcule are filtered using [[lipinskis-rule-of-five|Lipinski's Rule of Five]] to ensure drug-likeness.
