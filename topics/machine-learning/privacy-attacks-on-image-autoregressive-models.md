...
2. **Dataset Inference (DI):** The study demonstrates that IARs are highly susceptible to [[dataset-inference|Dataset Inference]]. The researchers found that as few as **4 samples** are required to detect dataset membership in IARs, whereas Diffusion Models require roughly **200 samples**. This indicates a much higher level of information leakage within the autoregressive architecture.
