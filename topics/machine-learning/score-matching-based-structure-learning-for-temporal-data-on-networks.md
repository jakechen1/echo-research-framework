...
The PICK algorithm extends the utility of [[machine learning]]-based causal discovery in several ways:

* **Temporal and Static Integration**: Unlike previous models, PICK can handle both static data and [[temporal data]] on networks featuring weak network interference.
