...
## Empirical Results
Experiments conducted on [[imagenet|ImageNet]] 256x256 using SiT backbones showed substantial improvements in generative quality. The researchers reported an increase in Inception Score (IS) by up to 6.11 and a reduction in FID by up to 3.41. Notably, the "warmup" approach allows models to reach standard baseline quality tens of thousands of iterations faster than traditional methods.
