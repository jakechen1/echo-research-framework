...
**Multiplayer Nash Preference Optimization (MNPO)** is a novel algorithmic framework designed to enhance the alignment of [[Large Language Models]] (LLMs) with complex, real-world human preferences.

## Background
Traditional [[Reinforcement Learning from Human Feedback]] (RLHF) paradigms largely rely on the [[Bradley-Terry model]], which assumes a transitive preference structure. However, real-world human preferences are often [[nontransitive]] (where preferences do not follow a consistent hierarchy) and highly [[heterogeneity]] (inconsistent across different individuals).
