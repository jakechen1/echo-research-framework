...
To quantify these risks, the paper introduces the **Reward Hacking Severity Index (RHSI)**, a metric designed to detect the divergence between proxy rewards and true [[learning progress]].
