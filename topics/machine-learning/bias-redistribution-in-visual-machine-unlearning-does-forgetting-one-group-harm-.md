...
The research paper **"Bias Redistribution in Visual Machine Unlearning: Does Forgetting One Group Harm Another?"** explores a critical, overlooked dimension of [[an-illusion-of-unlearning-assessing-machine-unlearning-through-internal-represen|Machine Unlearning]]: the impact on [[algorithmic-fairness|Algorithmic Fairness]]. While machine unlearning is essential for complying with privacy frameworks like [[gdpr|GDPR]] and [[ccpa|CCPA]], this study investigates whether the process of selectively forgetting training data inadvertently reshapes and amplifies biases within a model's [[geometric-organization-of-cognitive-states-in-transformer-embedding-spaces|Embedding Space]].

### Experimental Methodology
The researchers utilized [[eclipse-a-composable-pipeline-for-predicting-ecdna-formation-evolution-and-thera|CLIP]] models (specifically ViT/B-32, ViT-L/14, and ViT-B/16) to assess zero-shot classification performance on the [[celeba|CelebA]] dataset. The study focused on intersectional groups defined by the intersection of age and gender. To evaluate the efficacy and side effects of unlearning, three distinct methods were analyzed:

*   [[prompt-erasure|Prompt Erasure]]
*   [[prompt-reweighting|Prompt Reweighting]]
*   [[refusal-vector|Refusal Vector]]
