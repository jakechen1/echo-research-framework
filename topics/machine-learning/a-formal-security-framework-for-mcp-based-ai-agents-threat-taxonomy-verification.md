...
4.  **Defense in Depth Architecture**: A reference architecture that integrates capability-based [[access-control|Access Control]], cryptographic tool attestation, information flow tracking, and runtime policy