...
* **Efficiency in [[adaptive-rag|Adaptive RAG]]**: By providing a global score, the model allows [[contradictions-in-context-challenges-for-retrieval-augmented-generation-in-healt|Retrieval-Augmented Generation]] controllers to use external retrieval more selectively, saving computational resources.
