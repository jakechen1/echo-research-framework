...
**First-Mover Bias** is a mechanistic phenomenon identified in [[Gradient Boosting]] where the sequential nature of residual fitting leads to a path-dependent concentration of [[SHAP]] feature importance. This bias serves as a primary contributor to [[attribution instability]], particularly when models are subjected to high levels of [[multicollinearity]].
