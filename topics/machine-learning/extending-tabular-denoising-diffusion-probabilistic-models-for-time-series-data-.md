...
The research presented in arXiv:2604.05257 addresses a significant limitation in existing [[generative models]] used for data synthesis. While [[Tabular Denoising Diffusion Probabilistic Models]] (TabDDPM) have proven highly effective at generating high-quality synthetic [[tabular data]], their underlying architecture assumes independence between samples. This fundamental assumption renders them ineffective for [[time-series]] domains, where temporal dependencies and sequential patterns are the defining characteristics of the dataset.
