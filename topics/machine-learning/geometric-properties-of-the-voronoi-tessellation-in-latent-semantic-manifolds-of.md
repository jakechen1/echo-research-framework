...
A major contribution of this paper is the introduction of [[margin-refinement-procedures|Margin Refinement Procedures]] (MRP). These are short, post-hoc optimization techniques designed to reshape the Voronoi tessellation to widen token-decision margins without the need for full model retraining.
...
*   **Fisher Information Distance Maximization:** Utilizes [[fisher-information|Fisher Information]] to guide refinement. This method maintains a constant level of collateral damage