...
The authors propose a novel approach termed **caution**, which is inspired by the principle of **pessimism** found in [[Reinforcement Learning]]. While traditional "curiosity" models use prediction error as a signal for novelty and exploration, the "caution" framework treats prediction error as a signal of **[[Out-of-Distribution (OOD)]]** uncertainty.
