...
* **Lack of Spatial Understanding:** In path-planning tasks involving unknown cells, GPT-5 demonstrated a 93% success rate. However, the study found that the failure cases were not random; they exhibited a fundamental lack of the structural [[spatial-reasoning|spatial reasoning]] necessary for reliable navigation.
...
* **Critical Error Modes:** Across all tested models, the researchers identified several recurring failure types, including [[hallucinated-reasoning|hallucinated reasoning]], [[structural-collapse|structural collapse]], [[constraint-violations|constraint violations]], and highly [[unsafe-decisions|unsafe decisions]].

## Conclusion
The authors conclude that the field must move away from aggregate success metrics and toward a [[failure-focused-analysis|failure-focused analysis]]. To ensure the safe deployment of [[autonomous-systems|autonomous systems]], a more granular and rigorous evaluation framework is required to address the fundamental cognitive gaps identified in current [[artificial-intelligence-and-the-structure-of-mathematics|Artificial Intelligence]] architectures.