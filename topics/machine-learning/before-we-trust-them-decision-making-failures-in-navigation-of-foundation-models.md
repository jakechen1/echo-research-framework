...
The research paper "Before We Trust Them: Decision-Making Failures in Navigation of Foundation Models" identifies a critical discrepancy between the reported success rates of [[Foundation Models]] and their actual reliability in [[navigation]]-related decision-making. The authors argue that high-level performance metrics often mask profound underlying vulnerabilities that could lead to catastrophic failures in real-world applications.
