...
## Overview
As [[a-family-of-open-time-series-foundation-models-for-the-radio-access-network|Foundation Models]] grow in scale, traditional fine-tuning becomes computationally prohibitive. While PEFT methods like [[evgeoqa-benchmarking-llms-on-dynamic-multi-objective-geo-spatial-exploration|LoRA]] (Low-Rank Adaptation) and [[adalora|AdaLoRA]] allow for scalable adaptation by injecting low-rank matrices, the secondary challenge of transmitting and storing these adapters remains significant. This is particularly problematic in [[distributed-systems|Distributed Systems]] and [[multi-turn-reasoning-llms-for-task-offloading-in-mobile-edge-computing|Edge Computing]] environments where bandwidth and memory are strictly limited.
...
* **Model Agnostic:** SOLAR is compatible with existing PEFT architectures, including [[evgeoqa-benchmarking-llms-on-dynamic-multi-objective-geo-spatial-exploration|LoRA]] and [[adalora|AdaLoRA]].
