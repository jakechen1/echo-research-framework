...
To address security concerns, the authors utilize [[control-theory|Control Theory]] to frame the design of a robust forecaster as a [[solving-a-stackelberg-game-on-transportation-networks-in-a-dynamic-crime-scenari|Stackelberg Game]]. In this setup, the forecaster acts as the leader, and a stealthy adversary—constrained by a specific detection budget—acts as the follower. The paper proposes [[nearest-neighbor-projection-removal-adversarial-training|Adversarial Training]] as a viable solution to mitigate these risks.
