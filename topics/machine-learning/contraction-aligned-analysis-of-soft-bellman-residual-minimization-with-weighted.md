...
* **Optimization Compatibility**: The proposed formulation is designed to remain compatible with existing [[gradient-based optimization]] frameworks, making it practical for large-scale [[machine-learning]] applications.

By reconciling the $L_p$-norm objective with the $L_\infty$ contraction property, this work provides a foundation for more stable and mathematically sound algorithms in the field of [[Reinforcement Learning]] and [[optimal control]].