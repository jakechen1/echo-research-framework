...
This article explores the deployment efficiency of [[Large Language Models]] (LLMs) within [[Contextual Multi-Armed Bandits]] (CMABs). This specific class of [[machine-learning]] models is essential for non-episodic sequential decision-making where the decision context comprises both textual and numerical data—a common requirement in [[finance]] for tasks such as recommendation engines and dynamic portfolio management.
...
2. **Lack of Uncertainty Quantification:** It is notoriously difficult to extract reliable [[uncertainty estimation]] from LLM outputs to guide the [[exploration-exploitation trade-off]].
...
* **Performance of Embeddings:** Lightweight numerical bandits that operate on [[text embeddings]] (including dense and [[Matryoshka embeddings]]) were found to match or outperform LLM-driven solutions at a fraction of the computational cost.
...
## Conclusion
By providing a decision framework, this research enables the development of scalable, cost-effective, and uncertainty-aware [[AI]] systems suitable for high-stakes environments in [[financial services]].