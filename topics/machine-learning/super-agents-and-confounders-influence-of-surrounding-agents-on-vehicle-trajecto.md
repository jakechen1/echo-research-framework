...
Using [[shapley-based-attribution|Shapley-based attribution]], the researchers rigorously demonstrated that state-of-the-art predictors often rely on unstable and non-causal decision-making schemes. These models frequently learn patterns that vary significantly across different training runs, making them unreliable in high-stakes, real-world environments.
