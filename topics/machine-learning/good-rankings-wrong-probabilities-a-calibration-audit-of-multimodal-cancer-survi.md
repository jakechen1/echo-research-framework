...
The research paper "Good Rankings, Wrong Probabilities" presents a critical evaluation of [[multimodal deep learning]] models used for [[cancer survival]] prediction. While these models—which integrate [[whole-slide images]] (WSI) with [[genomic data]]—frequently achieve high [[concordance index]] (C-index) scores, this study highlights a significant discrepancy between a model's ability to rank patients correctly and its ability to provide accurate [[survival probabilities]].
...
3.  **Metric Insufficiency:** The most significant takeaway is that the [[concordance index]] is an insufficient metric for evaluating [[survival models]] intended for [[clinical decision support]].
