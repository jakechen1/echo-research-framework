...
In a large-scale production evaluation involving tens of millions of users, CASE demonstrated significant measurable gains, achieving up to an **8.6% relative Precision lift** and a **9.9% Recall lift** at the top-5 recommendation cutoff. These results highlight the importance of [[temporal-modeling|Temporal Modeling]] in driving the accuracy of [[retail-analytics|Retail Analytics]] and large-scale industrial recommendation engines.