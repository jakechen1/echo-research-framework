...
3. **Context**: A fundamental mismatch between static benchmarks and the open-ended, generative nature of real-world [[natural-language-processing|Natural Language Processing]] applications.
