...
created: 2024-05-22
source: https://arxiv.org/abs/2603.28507
tags: [scaling-laws, compute-efficiency, hardware, ai-economics]
...
A pivotal distinction made in the paper is the distinction between **logical compute** and **physical compute**. While classical scaling laws provide a predictable framework for model progress, they primarily track logical operations. However, the authors argue that the actual physical resources—silicon, energy, and infrastructure—required to execute these operations are subject to diminishing returns.

The paper suggests that "diminishing returns" should not be interpreted as a plateau in intelligence, but rather as a rising operational burden. As the cost of achieving the next increment of logical compute rises, the efficiency with which physical hardware realizes that compute must increase to keep progress economically feasible.
...
The paper concludes that the future of scaling depends on whether the industry can achieve a consistent cycle of efficiency doublings.