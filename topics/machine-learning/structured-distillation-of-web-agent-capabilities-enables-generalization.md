...
The research paper "Structured Distillation of Web Agent Capabilities Enables Generalization" introduces a groundbreaking framework known as **Agent-as-Annotators**. This framework is designed to address the primary bottlenecks in deploying [[Large Language Models]] (LLMs) for complex web navigation tasks: the high operational cost and the heavy reliance on third-party APIs that make local, private deployment impractical.
...
*   **WebArena:** The student model achieved a score of 41.5%, notably surpassing [[Claude 3.5 Sonnet]] (36.0%) and [[GPT-4o]] (31.5%).
