...
The practical utility of this method is demonstrated through its application to sparse [[computational-tomography|Computational Tomography]] reconstruction. Experimental results indicate that the proposed approach achieves reconstruction quality competitive with classical [[total-variation|Total Variation]]-based reconstruction techniques while significantly reducing the total computational time. These findings suggest high potential for use in real-time-sensitive fields such as [[medical-imaging|Medical Imaging]] and [[computer-vision|Computer Vision]].