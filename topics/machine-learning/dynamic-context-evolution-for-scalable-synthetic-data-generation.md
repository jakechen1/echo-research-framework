...
2.  **Semantic Memory:** The system maintains a persistent index of [[embedding-models|Embedding Models]] (such as all-MiniLM-L6-v2) to track previously generated concepts. This allows the system to reject near-duplicates across disparate batches.
