...
The effectiveness of PolicyLong has been validated through rigorous testing on various long-context benchmarks. Using [[Qwen2.5-3B]] as a base, the method demonstrated consistent superiority over predecessor methods such as [[EntropyLong]] and [[NExtLong]]. 

Key findings include:
* **Benchmark Success**: Significant performance gains were observed on [[RULER]], [[HELMET]], and [[LongBench-v2]].
...
These results confirm that moving toward on-policy data evolution is a vital step in the advancement of [[machine-learning]] techniques for long-context processing.