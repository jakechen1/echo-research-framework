...
*   **Linear Term:** Incorporates gradient-aware sensitivity metrics, specifically utilizing first-order [[taylor-expansion|Taylor expansion]] and second-order [[fisher-information|Fisher information]] to determine individual filter importance.
