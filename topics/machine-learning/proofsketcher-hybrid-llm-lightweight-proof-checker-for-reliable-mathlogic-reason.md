...
**ProofSketcher** is an innovative hybrid framework designed to bridge the gap between the generative capabilities of [[large-language-models-for-outpatient-referral-problem-definition-benchmarking-an|Large Language Models]] (LLMs) and the rigorous verification standards of [[interactive-theorem-provers|Interactive Theorem Provers]] (ITPs). The system aims to solve the "reliability gap" in automated mathematical and logical reasoning.
...
* [[neural-symbolic-computing|Neural-Symbolic Computing]]
* [[logic-programming|Logic Programming]]
* [[machine-learning-reliability|Machine Learning Reliability]]