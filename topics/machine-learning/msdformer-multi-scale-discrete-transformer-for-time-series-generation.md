...
A significant contribution of this research is the integration of the [[rate-distortion-theorem|Rate-Distortion Theorem]] to validate the effectiveness of the DTM method. This mathematical foundation provides the necessary evidence to justify the rationality of the multi-scale approach, ensuring that the model's optimization process is theoretically grounded.
