...
Unlike many recent trends in [[Machine Learning]] that require massive-scale fine-tuning, VeoPlace operates using a zero-shot approach. It utilizes the inherent strengths of existing VLMs to guide a base placer by proposing and constraining macro placements to specific subregions of the chip canvas. To