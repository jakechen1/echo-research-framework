...
To facilitate widespread adoption within the [[Data Science]] community, a fast and user-friendly implementation has been released as an open-source resource. The **lumbermark** package is available for both [[Python]] and [[R]]. This accessibility allows practitioners across various scientific disciplines—ranging from [[Biology]] to heavy industrial application—to integrate robust clustering capabilities into their existing analytical workflows.
