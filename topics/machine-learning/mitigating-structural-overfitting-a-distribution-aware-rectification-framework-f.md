...
3.  **Distribution Shift:** A failure to generalize during [[inductive-learning|Inductive Learning]] tasks, where the model struggles to handle unseen graph structures due to a gap between training and inference distributions.
...
*   **Semantic Rectifier:** Built upon the principles of [[masked-autoencoders|Masked Autoencoders]], this module learns the latent feature manifold to recover natural semantic details lost during smoothing.
