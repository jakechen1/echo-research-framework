...
While the initial robust estimators provide strong theoretical bounds, the authors note that these procedures face [[intractable-computation|Intractable Computation]] issues. To bridge the gap between theory and practical application, the paper relaxes the solution concept from a pure Nash equilibrium to [[coarse-correlated-equilibria-cce|Coarse Correlated Equilibria (CCE)]]. 
