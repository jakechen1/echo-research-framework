...
The research paper "Corruption-robust Offline Multi-agent Reinforcement Learning From Human Feedback" addresses a critical vulnerability in [[Multi-agent Reinforcement Learning]] (MARL): the impact of adversarial data corruption when utilizing [[Reinforcement Learning from Human Feedback]] (RLHF) in an offline setting. 
