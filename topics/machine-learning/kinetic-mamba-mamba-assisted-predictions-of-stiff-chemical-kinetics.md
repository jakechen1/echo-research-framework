...
2.  **Constrained Mamba**: A specialized architecture designed to enforce physical laws—specifically mass conservation—while learning the underlying state dynamics. This ensures the model adheres to the fundamental principles of [[computational-chemistry|computational chemistry]].
