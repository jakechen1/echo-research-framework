...
By applying these models to [[command-line-interface-cli|Command Line Interface (CLI)]] and [[graphical-user-interface-gui|Graphical User Interface (GUI)]] settings, researchers have observed that learned runtimes can acquire basic interface primitives. Specifically, these models demonstrate success in **I/O alignment** and **short-horizon control**.
