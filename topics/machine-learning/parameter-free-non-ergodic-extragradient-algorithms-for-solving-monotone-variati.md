...
The results indicate that these parameter-free methods not only show strong last-iterate performance but also provide significant improvements over existing optimization methods in [[machine learning]] and computational mathematics.