...
* **Value-Guided Collaboration:** VGM$^2$P utilizes global [[advantage-values|Advantage Values]] to guide the coordination between agents. By doing so, it transforms the complex task of optimal policy learning into a more manageable process of [[conditional-behavior-cloning|Conditional Behavior Cloning]].
