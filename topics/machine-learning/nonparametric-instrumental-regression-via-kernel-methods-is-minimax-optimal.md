...
The paper establishes that under standard assumptions—specifically regarding eigenvalue decay and source conditions—the KIV algorithm achieves [[minimax-optimal]] learning rates for fixed smoothness classes. 
...
This work contributes significantly to the field of [[Machine Learning]] and [[Causal Inference]], providing the mathematical bounds necessary for designing robust non-linear instrumental variable estimators.