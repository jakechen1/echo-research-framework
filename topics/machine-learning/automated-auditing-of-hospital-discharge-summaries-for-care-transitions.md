...
This paper proposes a novel, automated framework for the large-scale auditing of discharge summaries using locally deployed [[large-language-models-llms|Large Language Models (LLMs)]]. A key innovation of this research is the emphasis on privacy-preserving [[artificial-intelligence-and-the-structure-of-mathematics|Artificial Intelligence]] in clinical settings. By utilizing locally deployed models, the framework mitigates the significant risks associated with processing sensitive patient data in the cloud, ensuring that clinical data remains within secure boundaries.
...
To validate the approach, the study utilized adult inpatient summaries from the [[mimic-iv|MIMIC-IV]] database. The findings demonstrate the feasibility of using [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|Machine Learning]] for automated clinical auditing