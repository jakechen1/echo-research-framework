...
2.  **Variance Reduction**: The authors prove that reducing $\varepsilon$ linearly decreases the conditional velocity variance. This reduction enables much more stable and efficient [[Ordinary Differential Equation]] (ODE) integration.
