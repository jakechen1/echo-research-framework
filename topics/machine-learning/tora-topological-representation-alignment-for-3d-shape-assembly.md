...
* **Enhanced Robustness:** TORA shows superior accuracy in-distribution and demonstrates significant gains in [[zero-shot-learning|zero-shot learning]] capabilities when encountering unseen real-world or synthetic datasets, effectively mitigating the challenges of [[feddap-domain-aware-prototype-learning-for-federated-learning-under-domain-shift|domain shift]].
