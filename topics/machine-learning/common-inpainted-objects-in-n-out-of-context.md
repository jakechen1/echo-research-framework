...
3.  **Context-enhanced Fake Detection:** Utilizing contextual cues to improve [[image-forensics|Image Forensics]] and the identification of manipulated media. Notably, this can be applied to state-of-the-art detection methods without the need for additional fine-tuning.
