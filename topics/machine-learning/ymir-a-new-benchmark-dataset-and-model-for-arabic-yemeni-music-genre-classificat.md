...
The study performed an exhaustive evaluation consisting of 30 separate experiments. The researchers compared various [[feature-extraction|Feature Extraction]] techniques, including:
*   Mel-spectrograms
*   [[mfcc|MFCC]] (Mel-frequency cepstral coefficients) at 13, 20, and 40 coefficients
*   Chroma features
*   FilterBank

The performance of YMCM was benchmarked against several standard [[benchmarking-deep-learning-for-future-liver-remnant-segmentation-in-colorectal-l|Deep Learning]] architectures, including [[alexnet|AlexNet]], [[vgg16|VGG16]], and [[mobilenet|MobileNet]].
