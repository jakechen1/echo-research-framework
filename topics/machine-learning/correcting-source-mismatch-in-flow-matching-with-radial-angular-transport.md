...
The paper "Correcting Source Mismatch in Flow Matching with Radial-Angular Transport" addresses a fundamental limitation in modern [[generative-modeling-of-granular-flow-on-inclined-planes-using-conditional-flow-m|Generative Modeling]]. Standard [[evoflows-evolutionary-edit-based-flow-matching-for-protein-engineering|Flow Matching]] architectures are typically constructed using a [[gaussian-distribution|Gaussian Distribution]] as the base source and Euclidean probability paths. While this approach is highly efficient, it introduces a structural "source mismatch" when attempting to model data that is inherently heavy-tailed or anisotropic.
