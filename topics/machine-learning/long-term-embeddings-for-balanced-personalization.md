...
The paper "**Long-Term Embeddings for Balanced Personalization**" addresses a fundamental tension in modern [[recommender systems]]: the balance between capturing immediate, transient user intent and maintaining an understanding of stable, long-term preferences.
...
To prevent [[data leakage]]—a common risk when the long-term signal and short-term sequence share the same temporal horizon in [[causal language modeling]]—the authors utilize a lagged window approach.
