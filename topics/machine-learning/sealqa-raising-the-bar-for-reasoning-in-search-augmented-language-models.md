...
*   **Limits of Test-Time Compute**: The researchers found that increasing [[test-time-compute|test-time compute]] does not provide a consistent or reliable path to improved accuracy; performance often plateaus or even declines during extended reasoning attempts.
