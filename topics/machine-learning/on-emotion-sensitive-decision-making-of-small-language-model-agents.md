...
The study introduces a specialized benchmark grounded in [[game-theory|Game Theory]]. The researchers developed decision templates that encompass:
* **Cooperative vs. Competitive incentives**
* **Complete vs. Incomplete information scenarios**

To test these templates, the authors utilized complex strategic environments and personae, including scenarios from [[Diplomacy (game)|Diplomacy]] and [[starcraft-ii|StarCraft II]], alongside diverse real-world human personas.
