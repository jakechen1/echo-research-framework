...
tags: [[Generative AI]], [[UAV]], [[Digital Twin]], [[Edge Computing]], [[Optimization]]
category: ai
---

# Joint Task Offloading, Inference Optimization and UAV Trajectory Planning for GAI-empowered ITDT

The research paper explores the integration of [[Generative AI]] (GAI) within the framework of an [[Intelligent Transportation Digital Twin]] (ITDT). As urban environments become increasingly complex, the use of [[Unmanned Aerial Vehicles]] (UAVs) is proposed to serve as mobile sensing and processing units. These UAVs are tasked with collecting raw data from roadside sensors and utilizing advanced models, specifically [[Diffusion Models]], to transform low-quality raw data into high-fidelity, valuable digital representations.
