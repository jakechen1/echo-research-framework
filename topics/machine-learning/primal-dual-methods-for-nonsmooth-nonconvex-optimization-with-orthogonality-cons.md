...
Numerical experiments confirm the practical utility of the method. When tested against state-of-the-art algorithms on both smooth and nonsmooth problems, the proposed primal-dual method demonstrated superior computational efficiency and significantly better scalability, making it a robust candidate for large-scale [[Machine Learning]] and [[Algorithmic Complexity]] applications.