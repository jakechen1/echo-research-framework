...
Because exact Bayesian inference is often computationally intractable for large-scale architectures, the field relies heavily on [[approximate-inference|Approximate Inference]] techniques. This article provides a comprehensive survey of the seminal research regarding these implementations. The paper compares various methods used to approximate the posterior distribution, evaluating their efficiency and accuracy in different contexts.
