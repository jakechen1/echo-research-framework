...
By applying [[rate-distortion-theory|Rate-Distortion Theory]] and Mutual Information Neural Estimation (MINE) to 14 biological foundation models, the study identifies three specific failure modes in modern [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|Machine Learning]] for science:
