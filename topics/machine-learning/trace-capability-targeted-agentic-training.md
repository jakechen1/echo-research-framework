...
*   **$\tau^2$-bench (Customer Service)**: TRACE achieved a +14.1 point improvement over the base agent and demonstrated higher efficiency than [[limits-of-difficulty-scaling-hard-samples-yield-diminishing-returns-in-grpo-tune|GRPO]] and [[gepa|GEPA]] by +9.2 and +7.4 points, respectively, given the same number of rollouts.
