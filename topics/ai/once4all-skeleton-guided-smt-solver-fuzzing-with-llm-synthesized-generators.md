...
**Once4All** is an innovative [[Artificial Intelligence]]-driven fuzzing framework designed to enhance the testing and reliability of [[Satisfiability Modulo Theory (SMT) Solvers]]. Because SMT solvers serve as the backbone for critical tasks such as [[Symbolic Execution]] and [[Automated Verification]], maintaining their correctness is essential for the security of modern software and programming languages.

## The Problem: Syntax and Overhead
As SMT solvers evolve, traditional [[Fuzzing]] techniques struggle to cover new, complex features. While recent research has leveraged [[Large Language Models]] (LLMs) to generate test formulas, two significant bottlenecks remain:
