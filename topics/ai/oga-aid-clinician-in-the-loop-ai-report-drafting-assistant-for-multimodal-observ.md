...
OGA-AID is a specialized [[Multi-Agent System]] designed to assist clinicians in the complex process of [[Gait Analysis]] during [[Post-Stroke Rehabilitation]]. The system functions as a drafting assistant, alleviating the cognitive load on healthcare professionals by automating the synthesis of complex, multi-source data into structured clinical reports.
...
## System Overview
OGA-AID utilizes a multi-agent [[Large Language Model]] (LLM) architecture. Rather than relying on a single processing pass, the system coordinates three specialized agents:
...
By delegating specific analytical tasks to these specialized agents, OGA-AID can provide a more nuanced and structured output than traditional [[Multimodal Learning]] baselines.
