...
To address these bottlenecks, AV-SQL introduces the concept of **Agentic Views**. Instead of attempting to generate a full query in one pass, the framework uses agent-generated [[common-table-expressions|Common Table Expressions]] (CTEs) to encapsulate intermediate logic and filter out irrelevant schema elements.
