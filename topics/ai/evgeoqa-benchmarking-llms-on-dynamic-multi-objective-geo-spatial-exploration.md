...
## Overview
**EVGeoQA** is a novel benchmarking framework designed to evaluate the proficiency of [[large-language-models-for-outpatient-referral-problem-definition-benchmarking-an|Large Language Models]] (LLMs) in handling dynamic, multi-objective [[evgeoqa-benchmarking-llms-on-dynamic-multi-objective-geo-spatial-exploration|geo-spatial]] environments. While existing [[geo-spatial-question-answering|Geo-Spatial Question Answering]] (GSQA) benchmarks focus primarily on static information retrieval, EVGeoQA introduces the complexity of real-world spatial planning, where user locations are constantly changing and objectives are multi-faceted.
...
The EVGeoQA benchmark is built upon [[electric-vehicle|Electric Vehicle]] (EV) charging scenarios. It utilizes a **location-anchored** and **dual-objective** design:
