...
Recent security intelligence indicates a critical [[supply-chain-attack|supply chain attack]] involving the official website of CPUID, the developer of widely used system diagnostic utilities [[cpu-z-and-hwmonitor-compromised|CPU-Z]] and [[cpu-z-and-hwmonitor-compromised|HWMonitor]]. Reports from [[bleepingcomputer|BleepingComputer]] and security researchers at [[vxunderground]] suggest that the CPUID website was hijacked to distribute malicious payloads disguised as legitimate software updates.
