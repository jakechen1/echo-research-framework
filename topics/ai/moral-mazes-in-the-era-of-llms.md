...
created: 2024-05-22
source: https://arxiv.org/abs/2603.20231
tags: [LLMs, workplace communication, social intelligence, AI evaluation, human-AI collaboration]
category: ai
---
...
* **Model Strength:** Weaker models tended to prefer direct and blunt communication, whereas stronger, larger-scale models showed a preference for more subtle and nuanced messaging.
* **Convergence:** As models scale, they exhibit greater agreement with one another, hinting at a convergence toward a shared set of communicative norms that may eventually differ from traditional human interaction.

The widespread adoption of LLMs in professional correspondence holds the potential to fundamentally reshape the landscape of corporate interpersonal dynamics.