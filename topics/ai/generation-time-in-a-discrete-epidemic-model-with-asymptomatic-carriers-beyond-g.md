...
This research introduces a sophisticated approach to calculating the intervals between successive cases in a transmission chain of [[Infectious Diseases]]. Moving away from traditional [[Markovian processes]] that rely on simplified geometric waiting times, the paper presents a non-Markovian, discrete-time [[Epidemic Model]] capable of accounting for complex transmission dynamics involving asymptomatic carriers.
...
By mathematically rearranging the terms of the [[Basic Reproduction Number]] ($R_0$)—specifically considering an asymptomatic primary case who may or may not eventually develop symptoms—the authors derived the probability distribution for the [[Generation Time]]. 
