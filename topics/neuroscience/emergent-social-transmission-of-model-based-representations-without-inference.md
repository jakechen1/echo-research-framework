...
The research paper "Emergent social transmission of model-based representations without inference" explores a fundamental question in [[Cognitive Science]]: how can complex, structural knowledge about an environment be passed between individuals through simple [[Social Learning]] mechanisms, without the need for computationally expensive [[Mentalizing]]?

## The Problem of Cognitive Load
In studying human intelligence, it is often assumed that we rely on the ability to infer the hidden beliefs and intentions of others. However, this "mind-reading" capability is computationally costly. An alternative perspective, rooted in [[Cultural Evolution]], suggests that complex cultural knowledge can be transmitted through simple behavioral cues and environmental observations, bypassing the need for deep social reasoning.

## Methodology
The researchers employed [[Reinforcement Learning]] simulations to test this hypothesis. They created an environment that was reconfigurable, presenting a challenge to a "naïve agent" searching for rewards. The study compared two distinct learning modes:
...
* **Model-Based Advantage:** The most significant benefits were observed in agents utilizing [[Model-based learning]]. These agents showed accelerated learning rates and developed more "expert-