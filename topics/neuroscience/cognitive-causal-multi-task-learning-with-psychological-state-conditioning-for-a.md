...
The **CauPsi** framework introduces a novel approach to [[cognitive-causal-multi-task-learning-with-psychological-state-conditioning-for-a|Multi-task learning]] (MTL) specifically designed for [[advanced-driver-assistance-systems|Advanced Driver Assistance Systems]] (ADAS). While traditional methods treat environmental perception and driver monitoring as spatially or logically independent objectives, CauPsi leverages principles from [[cognitive-science|Cognitive Science]] to model the complex causal dependencies between a driver's internal psychological state and the external traffic environment.
...
The study further highlights that the psychological state signal can be acquired in a self-supervised manner, identifying systematic patterns without the need for expensive, manually annotated psychological labels, making it highly scalable for [[autonomous-vehicles|Autonomous Vehicles]] and future [[human-computer-interactions-predict-mental-health|Human-Computer Interaction]] applications.