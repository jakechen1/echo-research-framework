...
created: 2024-05-22
source: "https://arxiv.org/abs/2602.07816"
tags: [neuromotor, eye-hand coordination, calligraphy, predictive control, neuroscience]
...
* **Individualized Windows:** The peak timing between saccade distance and pen speed varied widely, ranging from approximately -50 ms to 400 ms. 
* **Stability:** These predictive windows were highly stable and characteristic of the individual across different trials, suggesting a permanent temporal signature.
* **Predictive Strategy:** The predictive windows closely matched each participant's specific "pen catch-up time." This indicates that the eye does not merely react to the hand (reactive pursuit) but proactively stabilizes fixation based on predicted future velocity.
