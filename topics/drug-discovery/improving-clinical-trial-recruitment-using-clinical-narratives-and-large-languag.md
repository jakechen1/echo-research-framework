...
The process of screening patients for [[Clinical Trials]] enrollment remains a significant bottleneck in the [[Drug Discovery]] pipeline. Manual screening is labor-intensive and prone to error, often leading to under-enrollment and subsequent trial failures. The research paper "Improving Clinical Trial Recruitment using Clinical Narratives and Large Language Models" explores how advancements in [[Artificial Intelligence]] can automate and optimize this screening process.
...
Using the 2018 N2C2 Track 1 benchmark dataset, the study found that the **MedGemma** model, when paired with a [[RAG]] strategy, achieved the highest performance with a micro-F1 score of 89.05%. 
