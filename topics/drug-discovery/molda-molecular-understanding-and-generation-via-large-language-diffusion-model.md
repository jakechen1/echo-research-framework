...
* **Global Constraint Failure**: AR models struggle to account for non-local, global constraints, such as [[ring-closure|Ring Closure]] and complex [[chemical-validity|Chemical Validity]] requirements, because they lack a holistic view of the molecule during the sequential step.
