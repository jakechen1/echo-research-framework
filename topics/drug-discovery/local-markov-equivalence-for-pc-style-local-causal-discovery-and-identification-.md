...
The identification of [[Controlled Direct Effects (CDEs)]] is a cornerstone of causal analysis in many scientific domains, including [[drug-discovery]] and [[neuroscience]]. While CDEs can be identified when the underlying [[Directed Acyclic Graphs (DAGs)]] are known, practical applications rarely provide a complete causal map. Instead, researchers must work with the [[Essential Graph]], which represents the [[Markov equivalence class]] of DAGs sharing the same conditional independencies.
