...
created: 2023-10-27
source: https://arxiv.org/abs/2604.05556
tags: [mechanobiology, biophysics, cancer-research, piezo1]
category: biology
---
...
A primary goal of this research is to provide a physical explanation for these observed phenomena, particularly focusing on the **Marangoni effect**. The study explores how surface tension gradients drive the redistribution of Piezo1. Specifically, the research focuses on:

1.  The role of the **Marangoni effect** in creating the inhomogeneous distribution seen in epithelial cells.
2.  Identifying the driving forces behind the heightened Piezo1 activity characteristic of cancer cells.
3.  The influence of **membrane-mediated interactions** among Piezo1 molecules when they are grouped near FAs in epithelial cells.
