...
| Task | Title | Legacy ID | Tier | ETA | Status |
|------|-------|-----------|------|-----|--------|
| Task 3.1 | PubMed sweep "PH 	GDH allosteric / RBD" 2024-2026 | G-004 | local | — | **DONE** |
...
| **Task 4.2** | Vina top-2 	0 × 6RIH K4T pocket — ranked CSV + scatter | G-007 | cheaha | 1 d | **ACTIVE** |
...
| Task | Title | Legacy ID | Tier | ETA | Status |
|------|-------|-----------|------|-----|--------|
| Task 5.1 | Paper introduction draft | G-0	09 | Chrome-Claude | 2 d | pending |
