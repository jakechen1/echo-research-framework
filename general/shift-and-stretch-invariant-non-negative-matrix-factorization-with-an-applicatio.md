...
dc.title: "Shift- and stretch-invariant non-negative matrix factorization with an application to brain tissue delineation in emission tomography data"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/shift-and-stretch-invariant-non-negative-matrix-factorization-with-an-applicatio.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To address these challenges, the authors present a **shift- and stretch-invariant NMF** framework. The core innovation lies in performing the decomposition within the [[domain|frequency domain]]. By operating in this domain, the model can elegantly handle distortions through specific mathematical transformations:
...
The model is implemented using [[PyTorch]], facilitating its use in modern [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|machine-learning]] and [[benchmarking-deep-learning-for-future-liver-remnant-segmentation-in-colorectal-l|deep learning]] workflows.
