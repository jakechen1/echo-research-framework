...
dc.title: "VertAX: a differentiable vertex model for learning epithelial tissue mechanics"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/vertax-a-differentiable-vertex-model-for-learning-epithelial-tissue-mechanics.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
**VertAX** is a specialized computational framework designed for the differentiable modeling of confluent [[Epithelial Tissues]] using a [[vertax-a-differentiable-vertex-model-for-learning-epithelial-tissue-mechanics|Vertex Model]] approach. Built on the [[JAX]] library, the framework provides researchers with the tools to simulate and learn the complex mechanical interactions that drive tissue-scale reshaping and [[Morphogenesis]].
