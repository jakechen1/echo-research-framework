...
dc.title: "Region-R1: Reinforcing Query-Sided Region Cropping for Multi-Modal Re-Ranking"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/region-r1-reinforcing-query-side-region-cropping-for-multi-modal-re-ranking.md
dc.language: en
dc.rights: CC-BY-4.0
---
