...
dc.title: "A Robust SINDy Autoencoder for Noisy Dynamical System Identification"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/a-robust-sindy-autoencoder-for-noisy-dynamical-system-identification.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To mitigate this, researchers developed [[SINDy autoencoders]], which combine model discovery with [[are-sparse-autoencoders-useful-for-java-function-bug-detection|autoencoders]]. This allows the system to learn simplified latent coordinates and the governing equations simultaneously. Despite this, a primary obstacle remains: the sensitivity of these models to [[measurement error]] and environmental noise.
