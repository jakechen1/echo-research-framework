...
dc.title: "SeMoBridge: Semantic Modality Bridge for Efficient Few-Shot Adaptation of CLIP"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/semobridge-semantic-modality-bridge-for-efficient-few-shot-adaptation-of-clip.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Overview
The paper introduces **SeMoBridge**, a novel approach designed to improve the performance of [[Contrastive Language-Image Pretraining]] (CLIP) during [[cross-domain-few-shot-learning-for-hyperspectral-image-classification-based-on-m|few-shot learning]] tasks. While CLIP is widely recognized for its excellence in zero-shot classification, its efficiency decreases in low-data scenarios due to a phenomenon known as **intra-modal misalignment**.
...
## Related Topics
[[computer-vision|Computer Vision]] | [[improving-multimodal-learning-with-dispersive-and-anchoring-regularization|Multimodal Learning]] | [[benchmarking-deep-learning-for-future-liver-remnant-segmentation-in-colorectal-l|Deep Learning]] | [[Self-Supervised Learning]]