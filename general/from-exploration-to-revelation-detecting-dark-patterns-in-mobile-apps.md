...
dc.title: "From Exploration to Revelation: Detecting Dark Patterns in Mobile Apps"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/from-exploration-to-revelation-detecting-dark-patterns-in-mobile-apps.md
dc.language: en
dc.rights: CC-BY-4.0
---
