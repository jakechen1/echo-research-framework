...
dc.title: "Three Phases of Expert Routing: How Load Balance Evolves During Mixture-of-Experts Training"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/three-phases-of-expert-routing-how-load-balance-evolves-during-mixture-of-expert.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The research paper **"Three Phases of Expert Routing: How Load Balance Evolves During Mixture-of-Experts Training"** introduces a novel framework for understanding the dynamic behavior of token routing in [[efficient-quantization-of-mixture-of-experts-with-theoretical-generalization-gua|Mixture-of-Experts]] (MoE) models. By modeling token routing as a [[Congestion Game]], the authors identify a non-monotone evolution of routing logic during the training process.
