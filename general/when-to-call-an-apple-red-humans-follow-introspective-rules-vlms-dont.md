...
dc.title: "When to Call an Apple Red: Humans Follow Introspective Rules, VLMs Don't"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/when-to-call-an-apple-red-humans-follow-introspective-rules-vlms-dont.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The findings reveal a stark divergence between [[human cognition]] and [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|machine learning]] capabilities. 
