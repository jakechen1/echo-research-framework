...
dc.title: "Neural Assistive Impulses: Synthesizing Exaggerated Motions for Physics-based Characters"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/neural-assistive-impulses-synthesizing-exaggerated-motions-for-physics-based-cha.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Overview
In the field of [[Physics-based character animation]], a primary goal is the synthesis of realistic and physically plausible motions. While modern [[deep-reinforcement-learning|Deep Reinforcement Learning]] (DRL) frameworks have successfully enabled characters to perform complex skills, they are fundamentally constrained by the laws of [[Classical Mechanics]]. Specifically, when modeling characters as underactuated, floating-base systems, [[momentum conservation]] strictly prohibits "exaggerated" or "stylized" motions—such as instantaneous dashes or sudden mid-air trajectory shifts—that are frequently required in [[Digital Humans]] and [[Computer Animation]].
