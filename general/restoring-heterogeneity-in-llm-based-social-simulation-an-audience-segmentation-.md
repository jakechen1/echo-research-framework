...
dc.title: "Restoring Heterogeneity In LLM Based Social Simulation An Audience Segmentation "
dc.creator: wiki-pipeline
dc.date: 2026-04-12
dc.type: Text
dc.format: text/markdown
dc.identifier: general/restoring-heterogeneity-in-llm-based-social-simulation-an-audience-segmentation-.md
dc.language: en
dc.rights: CC-BY-4.0
---
