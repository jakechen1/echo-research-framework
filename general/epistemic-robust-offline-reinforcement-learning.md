...
dc.title: "Epistemic Robust Offline Reinforcement Learning"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/epistemic-robust-offline-reinforcement-learning.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
2. **Uncertainty Conflation:** Ensemble-based methods often fail to distinguish between [[epistemic uncertainty]] (uncertainty due to a lack of data) and [[aleatoric-uncertainty-medical-image-segmentation-estimation-via-flow-matching|aleatoric uncertainty]] (inherent randomness in the environment).
...
The authors also introduce a new benchmark specifically designed to evaluate [[offline-rl-for-adaptive-policy-retrieval-in-prior-authorization|Offline RL]] algorithms under risk-sensitive behavior policies. Experimental results across both [[tabular reinforcement learning]] and [[continuous control]] domains demonstrate that the proposed method achieves significantly improved robustness and generalization compared to traditional ensemble-based baselines.