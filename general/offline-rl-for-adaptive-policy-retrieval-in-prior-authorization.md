...
dc.title: "Offline RL for Adaptive Policy Retrieval in Prior Authorization"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/offline-rl-for-adaptive-policy-retrieval-in-prior-authorization.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The study evaluates several algorithms using trajectories generated from synthetic PA requests based on [[CMS coverage data]]. The researchers compared [[Conservative Q-Learning (CQL)]], [[Implicit Q-Learning (IQL)]], and [[Direct Preference Optimization (DPO)]] against a [[Behavioral Cloning (BC)]] baseline.

Key findings include:
* **Accuracy**: [[Conservative Q-Learning (CQL)]] achieved 92% decision accuracy, a significant improvement over traditional fixed-$K$ baselines.
* **Efficiency**: [[Implicit Q-Learning (IQL)]] maintained high accuracy while reducing retrieval steps by 44%.
* **Optimization**: [[Direct Preference Optimization (DPO)]] emerged as the most efficient "selective-accurate" model. It matched the 92% accuracy of CQL but required 47% fewer retrieval steps (10.6 vs 20.0).

The study concludes that [[Preference-based Learning]] is necessary to move beyond simple imitation and achieve a state of optimal efficiency on the [[Pareto frontier]], particularly when managing the trade-off between information density and retrieval latency.