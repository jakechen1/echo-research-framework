...
dc.title: "JTON: A Token-Efficient JSON Superset with Zen Grid Tabular Encoding for Large Language Models"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/jton-a-token-efficient-json-superset-with-zen-grid-tabular-encoding-for-large-la.md
dc.language: en
dc.rights: CC-BY-4.0
---
