...
dc.title: "HUKUKBERT: Domain-Specific Language Model for Turkish Law"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/hukukbert-domain-specific-language-model-for-turkish-law.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The development of HUKUKBERT involved training on a massive 18 GB cleaned legal corpus. To ensure deep comprehension of legal terminology, the researchers employed a hybrid [[domain|Domain-Adaptive Pre-Training]] (DAPT) methodology. This approach integrates several advanced masking strategies:
