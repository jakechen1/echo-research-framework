...
dc.title: "STQuant: Spatio-Temporal Adaptive Framework for Optimizer Quantization"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/stquant-spatio-temporal-adaptive-framework-for-optimizer-quantization-in-large-m.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Evaluations performed on popular architectures, including [[openai-says-its-new-model-gpt-2-is-too-dangerous-to-release-2019|GPT-2]] and [[Vision Transformer (ViT)]], demonstrate the effectiveness of the framework. STQuant achieved:
