...
dc.title: "An Imperfect Verifier is Good Enough: Learning with Noisy Rewards"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/an-imperfect-verifier-is-good-enough-learning-with-noisy-rewards.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Overview
This research paper examines the stability of [[deepsearch-overcome-the-bottleneck-of-reinforcement-learning-with-verifiable-rew|Reinforcement Learning]] with [[Verifiable Rewards]] (RLVR), a prominent methodology used during the post-training phase of [[large-language-models-for-outpatient-referral-problem-definition-benchmarking-an|Large Language Models]] (LLMs). The study addresses a critical uncertainty in [[a-mathematical-theory-of-evolution-for-self-designing-ais|AI]] development: how much error can a reward-giving "verifier" possess before it breaks the learning process?
