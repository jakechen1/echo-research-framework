...
dc.title: "Physics-Informed Neural Networks for Source Inversion and Parameters Estimation in Atmospheric Dispersion"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/physics-informed-neural-networks-for-source-inversion-and-parameters-estimation-.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To solve this, the authors leverage the power of [[curvature-aware-optimization-for-high-accuracy-physics-informed-neural-networks|Physics-Informed Neural Networks]] (PINNs). While PINNs are widely recognized for solving forward problems in [[Scientific Computing]], this work extends their utility to the simultaneous estimation of both sources and parameters. 
