...
dc.title: "Learning the Stellar Structure Equations via Self-supervised Physics-Informed Neural Networks"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/learning-the-stellar-structure-equations-via-self-supervised-physics-informed-ne.md
dc.language: en
dc.rights: CC-BY-4.0
---
