...
dc.title: "VarDrop: Enhancing Training Efficiency by Reducing Variate Redundancy in Periodic Time Series Forecasting"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/vardrop-enhancing-training-efficiency-by-reducing-variate-redundancy-in-periodic.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
1.  **k-dominant frequency hashing (k-DFH)**: This mechanism operates within the [[domain|Frequency Domain]]. By analyzing the ranked dominant frequencies of the variates, the algorithm generates hash values that allow the system to group tokens exhibiting similar periodic behaviors.
