...
dc.title: "SE-Enhanced ViT and BiLSTM-Based Intrusion Detection for Secure IIoT and IoMT Environments"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/se-enhanced-vit-and-bilstm-based-intrusion-detection-for-secure-iiot-and-iomt-en.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To better capture the sequential and temporal dependencies inherent in network traffic patterns, the model integrates [[memory|Bidirectional Long Short-Term Memory (BiLSTM)]] layers. Furthermore, to address the common problem of class imbalance in network datasets, the framework utilizes data-balancing techniques, including:
