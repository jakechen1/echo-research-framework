...
dc.title: "Initialisation Determines the Basin: Efficient Codebook Optimisation for Extreme LLM Quantization"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/initialisation-determines-the-basin-efficient-codebook-optimisation-for-extreme-.md
dc.language: en
dc.rights: CC-BY-4.0
---
