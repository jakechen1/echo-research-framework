...
dc.title: "CountsDiff: A Diffusion Model on the Natural Numbers for Generation and Imputation of Count-Based Data"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/countsdiff-a-diffusion-model-on-the-natural-numbers-for-generation-and-imputatio.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
A primary use case for CountsDiff is in the field of [[single-cell-rna-sequencing|single-cell RNA-seq]] imputation. By applying the model to fetal and heart cell atlases, the researchers demonstrated the model's ability to handle biological count assays. 
