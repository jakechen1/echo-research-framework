...
dc.title: "Hybrid Fourier Neural Operator for Surrogate Modeling of Laser Processing with a Quantum-Circuit Mixer"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/hybrid-fourier-neural-operator-for-surrogate-modeling-of-laser-processing-with-a.md
dc.language: en
dc.rights: CC-BY-4.0
---
