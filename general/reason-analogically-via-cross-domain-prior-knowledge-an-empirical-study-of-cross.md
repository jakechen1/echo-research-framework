...
dc.title: "Reason Analogically via Cross-domain Prior Knowledge: An Empirical Study of Cross-domain Knowledge Transfer for In-Context Learning"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/reason-analogically-via-cross-domain-prior-knowledge-an-empirical-study-of-cross.md
dc.language: en
dc.rights: CC-BY-4.0
---
