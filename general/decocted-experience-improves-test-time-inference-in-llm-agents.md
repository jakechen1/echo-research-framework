...
dc.title: "Decocted Experience Improves Test-Time Inference in LLM Agents"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/decocted-experience-improves-test-time-inference-in-llm-agents.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The research paper "Decocted Experience Improves Test-Time Inference in LLM Agents" presents a novel framework for enhancing the performance of [[large-language-models-for-outpatient-referral-problem-definition-benchmarking-an|Large Language Models]] (LLMs) without the intensive requirement of updating model parameters. While the field has seen significant progress through [[test-time scaling]]—the practice of increasing computation during inference through extended reasoning or search—this paper identifies a critical bottleneck in current methodologies.

### The Problem: Inefficient Scaling
As tasks transition from simple queries to complex [[dynamic-agentic-ai-expert-profiler-system-architecture-for-multidomain-intellige|Agentic AI]] workflows, naive scaling of [[inference-time computation]] (such as increased sampling or tree search) becomes increasingly inefficient. The researchers observe that simply adding more compute often leads to a "wasted budget," where the model explores suboptimal paths that do not contribute to the final solution, particularly in high-complexity environments like [[triage-routing-software-engineering-tasks-to-cost-effective-llm-tiers-via-code-q|software engineering]] or web navigation.
