...
dc.title: "Quantization Impact on the Accuracy and Communication Efficiency Trade-off in Federated Learning for Aerospace Predictive Maintenance"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/quantization-impact-on-the-accuracy-and-communication-efficiency-trade-off-in-fe.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
*   **Instability of Extreme Quantization:** While **INT2** quantization appeared to lower Mean Absolute Error (MAE) in some instances through extreme quantization-induced over-regularization, it introduced catastrophic instability. Under [[Non-IID]] conditions, the coefficient of variation (CV) jumped to 45.8% (compared to 22.3%