...
dc.title: "The Theory and Practice of Highly Scalable Gaussian Process Regression with Nearest Neighbours"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/the-theory-and-practice-of-highly-scalable-gaussian-process-regression-with-near.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To mitigate this, approximation methods such as [[gaussian-process|Nearest Neighbour Gaussian Process]] (NNGP) and $GPnn$ have been developed. These methods achieve high scalability by restricting the prediction of a test point to its $k$-nearest neighbors, a technique frequently applied in [[Geospatial Analysis]] and large-scale [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|Machine Learning]]-driven tasks. While these methods demonstrate impressive empirical success, their large-scale statistical properties were previously analytically incomplete.
