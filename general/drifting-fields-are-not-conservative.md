...
dc.title: "Drifting Fields are not Conservative"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/drifting-fields-are-not-conservative.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The paper "Drifting Fields are not Conservative" explores the mathematical properties of [[Drifting Models]], a specialized class of [[generative-modeling-of-granular-flow-on-inclined-planes-using-conditional-flow-m|Generative Modeling]] designed to generate high-quality samples in a single forward pass. These models function by transporting initial samples toward a target data distribution using a vector-valued [[Drift Field]].
