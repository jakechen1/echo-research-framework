...
dc.title: "Infusion: Shaping Model Behavior by Editing Training Data via Influence Functions"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/infusion-shaping-model-behavior-by-editing-training-data-via-influence-functions.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The researchers evaluated Infusion across both [[computer-vision|Computer Vision]] and [[Natural Language Processing]] domains, yielding several key insights:
