...
dc.title: "OpenGLT: A Comprehensive Benchmark of Graph Neural Networks for Graph-Level Tasks"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/openglt-a-comprehensive-benchmark-of-graph-neural-networks-for-graph-level-tasks.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Graphs serve as the fundamental data structure for modeling complex interactions within domains such as [[social networks]], [[molecular structures]], and [[logic|biological systems]]. Within these fields, **graph-level tasks**—which involve predicting properties or labels for entire graphs—are essential for breakthroughs in areas like [[molecular property prediction]] and subgraph counting.
