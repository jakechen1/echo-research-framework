...
dc.title: "Hybrid ResNet-1D-BiGRU with Multi-Head Attention for Cyberattack Detection in Industrial IoT Environments"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/hybrid-resnet-1d-bigru-with-multi-head-attention-for-cyberattack-detection-in-in.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
*   **Robustness**: The model achieved a 0% False Positive Rate (FPR) on the CICIoV2024 dataset, making it highly reliable for mission-critical [[security|Cybersecurity]] applications.
