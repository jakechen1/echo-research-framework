...
dc.title: "Mitigating Value Hallucination in Dyna Planning via Multistep Predecessor Models"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/mitigating-value-hallucination-in-dyna-planning-via-multistep-predecessor-models.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
1. **Directionality**: Using [[Successor Models]] (forward simulation) versus [[mitigating-value-hallucination-in-dyna-planning-via-multistep-predecessor-models|Predecessor Models]] (backward simulation).
