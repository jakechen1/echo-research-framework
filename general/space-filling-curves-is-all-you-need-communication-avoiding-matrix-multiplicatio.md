...
dc.title: "Space Filling Curves is All You Need: Communication-Avoiding Matrix Multiplication Made Simple"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/space-filling-curves-is-all-you-need-communication-avoiding-matrix-multiplicatio.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The paper "Space Filling Curves is All You Need: Communication-Avoiding Matrix Multiplication Made Simple" presents a breakthrough in optimizing [[General Matrix Multiplication (GEMM)]], which serves as the fundamental computational backbone for both [[High-Performance Computing (HPC)]] and [[benchmarking-deep-learning-for-future-liver-remnant-segmentation-in-colorectal-l|Deep Learning]].
