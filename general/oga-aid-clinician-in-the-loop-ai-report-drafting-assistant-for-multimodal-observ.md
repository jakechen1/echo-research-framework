...
dc.title: "OGA-AID: Clinician-in-the-loop AI Report Drafting Assistant"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/oga-aid-clinician-in-the-loop-ai-report-drafting-assistant-for-multimodal-observ.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
OGA-AID is a specialized [[emomas-emotion-aware-multi-agent-system-for-high-stakes-edge-deployable-negotiat|Multi-Agent System]] designed to assist clinicians in the complex process of [[Gait Analysis]] during [[Post-Stroke Rehabilitation]]. The system functions as a drafting assistant, alleviating the cognitive load on healthcare professionals by automating the synthesis of complex, multi-source data into structured clinical reports.
