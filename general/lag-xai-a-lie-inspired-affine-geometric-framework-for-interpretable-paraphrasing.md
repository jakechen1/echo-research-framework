...
dc.title: "LAG-XAI: A Lie-Inspired Affine Geometric Framework"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/lag-xai-a-lie-inspired-affine-geometric-framework-for-interpretable-paraphrasing.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The effectiveness of LAG-XAI was tested using [[Sentence-BERT]] on the noisy PIT-2015 Twitter corpus. The researchers observed a phenomenon termed "linear transparency." While the proposed affine operator achieved an AUC of 0.7713—notably lower than the non-linear baseline's AUC of 0.8405—it retained approximately 80% of the baseline's effective classification capacity. This marginal loss in absolute accuracy is compensated for by the gain in [[a-multi-level-causal-intervention-framework-for-mechanistic-interpretability-in-|Mechanistic Interpretability]], as the model provides explicit, parametric explanations for semantic shifts.
