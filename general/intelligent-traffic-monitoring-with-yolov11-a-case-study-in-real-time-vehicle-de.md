...
dc.title: "Intelligent Traffic Monitoring with YOLOv11: A Case Study in Real-Time Vehicle Detection"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/intelligent-traffic-monitoring-with-yolov11-a-case-study-in-real-time-vehicle-de.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
### Technical Framework
The core of the proposed system is a pipeline built upon the [[intelligent-traffic-monitoring-with-yolov11-a-case-study-in-real-time-vehicle-de|YOLOv11]] detector. To handle the complexities of movement and overlapping objects, the researchers integrated multi-object tracking (MOT) algorithms, specifically [[BoT-SORT]] and [[ByteTrack]]. The entire computational pipeline was developed using [[PyTorch]] and [[OpenCV]], providing a robust framework for processing visual data.
