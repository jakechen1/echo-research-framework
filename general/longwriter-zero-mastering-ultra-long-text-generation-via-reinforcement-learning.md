...
dc.title: "LongWriter-Zero: Mastering Ultra-Long Text Generation via Reinforcement Learning"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/longwriter-zero-mastering-ultra-long-text-generation-via-reinforcement-learning.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Previous approaches, such as the original [[longwriter-zero-mastering-ultra-long-text-generation-via-reinforcement-learning|LongWriter]], have primarily relied on [[Supervised Fine-Tuning]] (SFT). This method involves training models on synthetic long-form outputs. However, this "teaching" strategy presents several critical issues:
