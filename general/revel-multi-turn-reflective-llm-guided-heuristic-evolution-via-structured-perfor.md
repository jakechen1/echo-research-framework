...
dc.title: "ReVEL: Multi-Turn Reflective LLM-Guided Heuristic Evolution via Structured Performance Feedback"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/revel-multi-turn-reflective-llm-guided-heuristic-evolution-via-structured-perfor.md
dc.language: en
dc.rights: CC-BY-4.0
---
