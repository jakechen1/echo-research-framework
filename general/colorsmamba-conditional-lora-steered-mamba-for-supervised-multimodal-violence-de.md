...
dc.title: "CoLoRSMamba: Conditional LoRA-Steered Mamba for Supervised Multimodal Violence Detection"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/colorsmamba-conditional-lora-steered-mamba-for-supervised-multimodal-violence-de.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The architecture utilizes a directional "Video to Audio" approach, integrating [[VideoMamba]] and [[AudioMamba]] through a specialized mechanism known as CLS-guided conditional [[evgeoqa-benchmarking-llms-on-dynamic-multi-objective-geo-spatial-exploration|LoRA]] (Low-Rank Adaptation). Unlike traditional models that rely heavily on computationally expensive [[multi-modal-user-interface-control-detection-using-cross-attention|Cross-Attention]] layers, CoLoRSMamba uses the Visual CLS token to influence the audio processing stream directly.
