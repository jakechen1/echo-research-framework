...
dc.title: "What Makes an Ideal Quote? Recommending "Unexpected yet Rational" Quotations via Novelty"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/what-makes-an-ideal-quote-recommending-unexpected-yet-rational-quotations-via-no.md
dc.language: en
dc.rights: CC-BY-4.0
---
