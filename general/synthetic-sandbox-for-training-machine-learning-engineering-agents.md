...
dc.title: "Synthetic Sandbox for Training Machine Learning Engineering Agents"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/synthetic-sandbox-for-training-machine-learning-engineering-agents.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The research introduces **SandMLE**, a pioneering multi-agent framework designed to bridge the gap between [[Software Engineering (SWE)]] agent capabilities and the more complex requirements of [[machine-learning|Machine Learning Engineering (MLE)]].
...
* [[machine-learning|Automated Machine Learning (AutoML)]]
