...
dc.title: "ReCellTy: Domain-Specific Knowledge Graph Retrieval-Augmented LLMs Reasoning Workflow for Single-Cell Annotation"
dc.creator: wiki-pipeline
dc.date: 2024-05-21
dc.type: Text
dc.format: text/markdown
dc.identifier: general/recellty-domain-specific-knowledge-graph-retrieval-augmented-llms-reasoning-work.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
By providing a robust paradigm for integrating structured biological knowledge with generative AI, ReCellTy offers transformative potential for [[Bioinformatics]], [[Neuroscience]], and automated [[targeting-phgdh-for-alzheimers-disease-drug-discovery-strategies|Drug Discovery]] workflows.