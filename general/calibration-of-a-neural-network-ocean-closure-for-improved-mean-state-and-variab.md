...
dc.title: "Calibration of a neural network ocean closure for improved mean state and variability"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/calibration-of-a-neural-network-ocean-closure-for-improved-mean-state-and-variab.md
dc.language: en
dc.rights: CC-BY-4.0
---
