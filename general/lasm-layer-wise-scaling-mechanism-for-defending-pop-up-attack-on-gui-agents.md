...
dc.title: "LaSM: Layer-wise Scaling Mechanism for Defulating Pop-up Attack on GUI Agents"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/lasm-layer-wise-scaling-mechanism-for-defending-pop-up-attack-on-gui-agents.md
dc.language: en
dc.rights: CC-BY-4.0
---
