...
dc.title: "A Decomposition Perspective to Long-context Reasoning for LLMs"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/a-decomposition-perspective-to-long-context-reasoning-for-llms.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The paper "A Decomposition Perspective to Long-context Reasoning for LLMs" addresses a critical bottleneck in the evolution of [[Large Language Models (LLMs)]]: the difficulty of maintaining coherent reasoning over extended input sequences. While [[$pi^2$-structure-originated-reasoning-data-improves-long-context-reasoning-abili|Long-context reasoning]] is essential for many real-world applications, the authors argue that current research lacks a granular understanding of the internal complexities that make these tasks challenging.
