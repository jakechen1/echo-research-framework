...
dc.title: "SDVDiag: Using Context-Aware Causality Mining for the Diagnosis of Connected Vehicle Functions"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/sdvdiag-using-context-aware-causality-mining-for-the-diagnosis-of-connected-vehi.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To further refine the accuracy of the causal graphs, SDVDiag incorporates modules that leverage [[Distributed Tracing]] data. This allows the system to:
