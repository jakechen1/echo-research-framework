...
dc.title: "LatentAudit: Real-Time White-Box Faithfulness Monitoring for Retrieval-Augmented Generation with Verifiable Deployment"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/latentaudit-real-time-white-box-faithfulness-monitoring-for-retrieval-augmented-.md
dc.language: en
dc.rights: CC-BY-4.0
---
