...
dc.title: "KD-MARL: Resource- Aware Knowledge Distillation in Multi-Agent Reinforcement Learning"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/kd-marl-resource-aware-knowledge-distillation-in-multi-agent-reinforcement-learn.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Extensive testing conducted on standard MARL benchmarks, including [[SMAC]] (StarCraft Multi-Agent Challenge) and [[12k-tons-of-dumped-orange-peel-grew-into-a-landscape-nobody-expected-2017|MPE]] (Multi-Agent Particle Environment), demonstrates the efficacy of the approach. Key findings include:
