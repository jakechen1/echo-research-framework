...
dc.title: "SLaB: Sparse-Lowrank-Binary Decomposition for Efficient Large Language Models"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/slab-sparse-lowrank-binary-decomposition-for-efficient-large-language-models.md
dc.language: en
dc.rights: CC-BY-4.0
---
