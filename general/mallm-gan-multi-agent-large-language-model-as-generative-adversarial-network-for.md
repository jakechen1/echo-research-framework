...
dc.title: "MALLM-GAN: Multi-Agent Large Language Model as Generative Adversarial Network for Synthesizing Tabular Data"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/mallm-gan-multi-agent-large-language-model-as-generative-adversarial-network-for.md
dc.language: en
dc.rights: CC-BY-4.0
---
