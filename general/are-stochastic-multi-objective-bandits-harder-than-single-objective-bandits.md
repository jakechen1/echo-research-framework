...
dc.title: "Are Stochastic Multi-objective Bandits Harder than Single-objective Bandits?"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/are-stochastic-multi-objective-bandits-harder-than-single-objective-bandits.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
*   **Uncertainty-Greedy Rule:** A specific rule for dimension selection designed to balance [[machine-learning|Exploration (Machine Learning)]] and exploitation.
