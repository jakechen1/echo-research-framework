...
dc.title: "Recurrent Quantum Feature Maps for Reservoir Computing"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/recurrent-quantum-feature-maps-for-reservoir-computing.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
* **Superior Accuracy:** The quantum feature map approach achieved a lower Mean Squared Error (MSE) than several established [[machine-learning|Classical Machine Learning]] baselines, including [[Echo State Networks]] (ESN) and [[Multilayer Perceptrons]] (MLP).
