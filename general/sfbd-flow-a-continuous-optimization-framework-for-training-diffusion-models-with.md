...
dc.title: "SFBD Flow: A Continuous-Optimization Framework for Training Diffusion Models with Noisy Samples"
dc.creator: wiki-pipeline
dc.date: 2025-06-01
dc.type: Text
dc.format: text/markdown
dc.identifier: general/sfbd-flow-a-continuous-optimization-framework-for-training-diffusion-models-with.md
dc.language: en
dc.rights: CC-BY-4.0
---
