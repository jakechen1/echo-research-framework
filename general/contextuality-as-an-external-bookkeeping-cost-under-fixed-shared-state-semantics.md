...
dc.title: "Contextuality as an External Bookkeeping Cost under Fixed Shared-State Semantics"
dc.creator: wiki-pipeline
dc.date: 2025-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/contextuality-as-an-external-bookkeeping-cost-under-fixed-shared-state-semantics.md
dc.language: en
dc.rights: CC-BY-4.0
---
