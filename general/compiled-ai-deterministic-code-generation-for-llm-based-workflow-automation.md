...
dc.title: "Compiled AI: Deterministic Code Generation for LLM-Based Workflow Automation"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/compiled-ai-deterministic-code-generation-for-llm-based-workflow-automation.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Related Research
Compiled AI serves as a systems-oriented evolution of earlier work in [[pipeline|Declarative Pipeline Optimization]] (such as [[fedspy-llm-towards-scalable-and-generalizable-data-reconstruction-attacks-from-g|DSPy]]) and [[Hybrid Neural-Symbolic Planning]] (such as [[LLM+P]]), shifting the focus from real-time reasoning to the automated synthesis of reliable, executable logic.