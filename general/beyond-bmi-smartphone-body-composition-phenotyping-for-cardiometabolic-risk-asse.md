...
dc.title: "Beyond BMI: Smartphone Body Composition Phenotyping for Cardiometabolic Risk Assessment"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/beyond-bmi-smartphone-body-composition-phenotyping-for-cardiometabolic-risk-asse.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Overview
Traditional methods of assessing health risks often rely on [[index|Body Mass Index (BMI)]], which serves as a widely accessible but imprecise proxy for physiological health. While [[Dual-Energy X-ray Absorptiometry (DXA)]] remains the gold standard for assessing true body composition, its lack of scalability prevents widespread use in population-scale screening. 
