...
dc.title: "Accelerating Training of Autoregressive Video Generation Models via Local Optimization with Representation Continuity"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/accelerating-training-of-autoregressive-video-generation-models-via-local-optimi.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
While [[privacy-attacks-on-image-autoregressive-models|Autoregressive Models]] have achieved high-fidelity results in image synthesis, applying them to the temporal dimension of video introduces significant complexity. A common strategy to reduce training time is to train on fewer video frames (subsampling); however, the authors demonstrate that this approach leads to severe [[Error Accumulation]] and temporal inconsistencies in the resulting video sequences.
