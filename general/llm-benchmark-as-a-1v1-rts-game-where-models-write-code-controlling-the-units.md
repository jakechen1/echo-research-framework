...
dc.title: "LLM 'benchmark' as a 1v1 RTS game where models write code controlling the units"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/llm-benchmark-as-a-1v1-rts-game-where-models-write-code-controlling-the-units.md
dc.language: en
dc.rights: CC-BY-4.0
---
