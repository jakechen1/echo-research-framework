...
dc.title: "LUDOBENCH: Evaluating LLM Behavioural Decision-Making Through Spot-Based Board Game Scenarios in Ludo"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/ludobench-evaluating-llm-behavioural-decision-making-through-spot-based-board-ga.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
LudoBench is a novel benchmarking framework designed to evaluate the [[Strategic Reasoning]] capabilities of [[large-language-models-for-outpatient-referral-problem-definition-benchmarking-an|Large Language Models]] (LLMs) within the context of Ludo—a stochastic, multi-agent board game. Unlike traditional benchmarks that focus on linguistic proficiency, LudoBench assesses how models navigate complex game mechanics, such as piece capture, safe-square navigation, and progress toward a home path.
...
LudoBench provides a lightweight and interpretable framework for studying [[before-we-trust-them-decision-making-failures-in-navigation-of-foundation-models|Decision-Making]] under [[Stochastic Processes]] and uncertainty. It serves as a vital tool for researchers investigating the limits of [[strategic-persuasion-with-trait-conditioned-multi-agent-systems-for-iterative-le|Multi-Agent Systems]] and the robustness of LLMs in environments requiring long-term planning and adaptation to random variables.
