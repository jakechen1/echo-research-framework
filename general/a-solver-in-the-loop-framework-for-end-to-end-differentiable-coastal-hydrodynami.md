...
dc.title: "A solver-in-the-loop framework for end-to-end differentiable coastal hydrodynamics"
dc.creator: wiki-pipeline
dc.date: 2023-10-27
dc.type: Text
dc.format: text/markdown
dc.identifier: general/a-solver-in-the-loop-framework-for-end-to-end-differentiable-coastal-hydrodynami.md
dc.language: en
dc.rights: CC-BY-4.0
---
