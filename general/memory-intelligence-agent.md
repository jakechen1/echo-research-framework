...
dc.title: "Memory Intelligence Agent"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/memory-intelligence-agent.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
*   **Memory Manager:** A [[memory|Non-parametric Memory]] system tasked with storing and compressing historical search trajectories, ensuring efficient data retention.
*   **Planner:** A [[memory|Parametric Memory]] agent capable of generating sophisticated search plans for complex queries.
