...
dc.title: "Automated Auditing of Hospital Discharge Summaries for Care Transitions"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/automated-auditing-of-hospital-discharge-summaries-for-care-transitions.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
To validate the approach, the study utilized adult inpatient summaries from the [[MIMIC-IV]] database. The findings demonstrate the feasibility of using [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|Machine Learning]] for automated clinical auditing