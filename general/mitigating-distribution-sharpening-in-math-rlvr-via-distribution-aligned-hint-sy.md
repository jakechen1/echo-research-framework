...
dc.title: "Mitigating Distribution Sharpening in Math RLVR via Distribution-Aligned Hint Synthesis and Backward Hint Annealing"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/mitigating-distribution-sharpening-in-math-rlvr-via-distribution-aligned-hint-sy.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
[[Backward Hint Annealing (BHA)]] addresses the need for hint removal. The method anneals hint exposure across different difficulty buckets. By implementing per-question hint dropout, the framework ensures that the model continues to receive unassisted updates, preventing a permanent reliance on scaffolds and preparing the model for no-hint [[epistemic-blinding-an-inference-time-protocol-for-auditing-prior-contamination-i|Inference]] evaluation.
