...
dc.title: "Analysis of non pharmaceutical interventions with SIR epidemic models: decreasing the infection peak vs. minimizing the epidemic size"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/analysis-of-non-pharmaceutical-interventions-with-sir-epidemic-models-decreasing.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
This article examines the impact of various [[analysis-of-non-pharmaceutical-interventions-with-sir-epidemic-models-decreasing|non-pharmaceutical interventions]] (NPIs) on the trajectory of infectious disease outbreaks using [[SIR models]]. The research specifically investigates the optimization of two different public health objectives: reducing the peak number of concurrent infections (often referred to as "flattening the curve") and minimizing the total [[epidemic size]] (the total number of people infected throughout the duration of the outbreak).

## Analytical Methodology

The study utilizes [[compartmental models]] to derive analytical approximations for the critical points of the infection curve. By employing [[degree-based mean-field networks]], the authors differentiate between two functional types of interventions:
...
* **Contact Reduction:** Measures similar to [[lockdown measures]] that focus on decreasing the density of social interactions.
...
1. **Efficiency of Measures:** When assuming an equal effect on the [[reproduction number]], interventions that focus on reducing the transmission rate are more effective at minimizing the final epidemic size than those focused solely on reducing social contact.
