...
dc.title: "Nearest Neighbor Projection Removal Adversarial Training"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/nearest-neighbor-projection-removal-adversarial-training.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The effectiveness of the Nearest Neighbor Projection Removal method was validated across several prominent benchmarks, including [[CIFAR-10]], [[CIFAR-100]], [[SVHN]], and [[TinyImagenet]]. The experimental results show that the method is highly competitive with current leading [[nearest-neighbor-projection-removal-adversarial-training|Adversarial Training]] techniques. Notably, the approach succeeds in bolstering robustness without sacrificing [[Clean Accuracy]], addressing one of the most common trade-offs in the field of [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|Machine Learning]].