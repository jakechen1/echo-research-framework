...
created: 2024-05-22
source: https://arxiv.org/abs/2604.05631
tags: [ai, epistemology, cognitive-science, machine-learning]
category: ai
author: wiki-pipeline
dc.title: "Beyond Behavior: Why AI Evaluation Needs a Cognitive Revolution"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/beyond-behavior-why-ai-evaluation-needs-a-cognitive-revolution.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Since 1950, the success of an AI system has largely been measured by its ability to mimic human-like responses. The authors contend that this reliance on observable behavior is not merely a practical choice but an epistemological commitment that has constrained AI research for seventy years. By focusing solely on whether a machine's output matches a human's, the field has rendered "unaskable" a wide range of critical questions regarding:

* **Internal Organization:** The structural arrangement of a model's components.
* **Computational Process:** The specific logic and mechanics used to arrive at an output.
* **Mechanism-based Intelligence:** The distinction between superficial mimicry and genuine functional reasoning.
