...
dc.title: "Label Effects: Shared Heuristic Reliance in Trust Assessment by Humans and LLM-as-a-Judge"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/label-effects-shared-heuristic-reliance-in-trust-assessment-by-humans-and-llm-as.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
### LLM Internal States
The researchers analyzed the internal mechanics of [[curvature-aware-optimization-for-high-accuracy-physics-informed-neural-networks|Neural Networks]] to determine if LLMs mirrored this human behavior. They discovered:
