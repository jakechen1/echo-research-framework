...
dc.title: "MG$^2$-RAG: Multi-Granularity Graph for Multimodal Retrieval-Augmented Generation"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/mg$^2$-rag-multi-granularity-graph-for-multimodal-retrieval-augmented-generation.md
dc.language: en
dc.rights: CC-BY-4.0
---
