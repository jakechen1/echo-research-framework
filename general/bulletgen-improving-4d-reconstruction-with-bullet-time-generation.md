...
dc.title: "BulletGen: Improving 4D Reconstruction with Bullet-Time Generation"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/bulletgen-improving-4d-reconstruction-with-bullet-time-generation.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
BulletGen introduces a hybrid approach that leverages [[synthetic-trust-attacks-modeling-how-generative-ai-manipulates-human-decisions-i|Generative AI]] to correct errors and complete missing information within a [[Gaussian-based dynamic scene representation]]. The core innovation is the integration of a **"bullet-time" step**. 
