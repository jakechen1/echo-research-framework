...
dc.title: "CPU-Z and HWMonitor compromised"
dc.creator: wiki-pipeline
dc.date: 2026-04-10
dc.type: Text
dc.format: text/markdown
dc.identifier: general/cpu-z-and-hwmonitor-compromised.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Recent security intelligence indicates a critical [[supply chain attack]] involving the official website of CPUID, the developer of widely used system diagnostic utilities [[cpu-z-and-hwmonitor-compromised|CPU-Z]] and [[cpu-z-and-hwmonitor-compromised|HWMonitor]]. Reports from [[BleepingComputer]] and security researchers at [[vxunderground]] suggest that the CPUID website was hijacked to distribute malicious payloads disguised as legitimate software updates.

## Incident Overview

The compromise focuses on the integrity of the download pipeline. Attackers gained the ability to manipulate the files hosted on the official CPUID servers, effectively turning a trusted utility into a delivery mechanism for [[explainability-guided-adversarial-attacks-on-transformer-based-malware-detectors|malware]]. Specifically, certain versions of [[cpu-z-and-hwmonitor-compromised|HWMonitor]] (notably version 1.63) have been flagged as potentially containing malicious code. 
...
The breach was brought to widespread attention through community monitoring on platforms such as [[Reddit]] and [[Hacker News]]. Security enthusiasts noticed discrepancies in file signatures and anomalous behavior in recent downloads. The incident has raised significant alarms within the [[security|cybersecurity]] community regarding the extreme vulnerability of essential system-level tools.
