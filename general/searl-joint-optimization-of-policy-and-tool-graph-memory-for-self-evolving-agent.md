...
dc.title: "SEARL: Joint Optimization of Policy and Tool Graph Memory for Self-Evolving Agents"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/searl-joint-optimization-of-policy-and-tool-graph-memory-for-self-evolving-agent.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Overview
**SEARL** is an innovative framework designed to facilitate the development of **self-evolving agents**. As the paradigm of [[artificial-intelligence-and-the-structure-of-mathematics|Artificial Intelligence]] shifts toward agentic learning—where models improve by synthesizing new tools and accumulating explicit experiences—SEARL provides a structured approach to autonomous learning without the massive computational overhead typically required by modern [[Large Language Models (LLMs)]].
