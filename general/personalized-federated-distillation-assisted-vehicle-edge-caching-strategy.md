...
dc.title: "Personalized Federated Distillation Assisted Vehicle Edge Caching Strategy"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/personalized-federated-distillation-assisted-vehicle-edge-caching-strategy.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
## Overview
The research paper "Personalized Federated Distillation Assisted Vehicle Edge Caching Strategy" addresses the critical infrastructure challenges within [[Internet of Vehicles (IoV)]] environments. As [[user|Vehicle Users (VUs)]] increasingly demand low-latency access to high-bandwidth content, [[personalized-federated-distillation-assisted-vehicle-edge-caching-strategy|Vehicle Edge Caching]] has emerged as a vital technology. This process involves pre-caching anticipated content at edge nodes, such as [[Road Side Units (RSUs)]], to minimize the delay experienced by moving vehicles.

## The Challenge
Implementing efficient caching in vehicular networks faces two primary hurdles:

1.  **Privacy vs. Overhead**: While [[Federated Learning (FL)]] provides a framework for protecting user privacy by sharing model parameters rather than raw, sensitive data, it is not without cost. The traditional FL process requires frequent model transmissions, which creates significant [[communication|Communication Overhead]] and consumes network bandwidth.
