...
dc.title: "SELFDOUBT: Uncertainty Quantification for Reasoning LLMs via the Hedge-to-Verify Ratio"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/selfdoubt-uncertainty-quantification-for-reasoning-llms-via-the-hedge-to-verify-.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The framework was evaluated across several rigorous [[a-comparative-analysis-of-machine-learning-models-in-shap-analysis|Machine Learning]] benchmarks, including [[BBH]], [[GPQA-Diamond]], and [[MMLU-Pro]]. Key outcomes include:
