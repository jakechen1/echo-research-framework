...
dc.title: "Pramana: Fine-Tuning Large Language Models for Epistemic Reasoning through Navya-Nyaya"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/pramana-fine-tuning-large-language-models-for-epistemic-reasoning-through-navya-.md
dc.language: en
dc.rights: CC-BY-4.0
---
