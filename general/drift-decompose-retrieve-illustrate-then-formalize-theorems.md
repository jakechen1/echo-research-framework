...
dc.title: "DRIFT: Decompose, Retrieve, Illustrate, then Formalize Theorems"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/drift-decompose-retrieve-illustrate-then-formalize-theorems.md
dc.language: en
dc.rights: CC-BY-4.0
---
