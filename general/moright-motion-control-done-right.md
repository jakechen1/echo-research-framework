...
dc.title: "MoRight: Motion Control Done Right"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/moright-motion-control-done-right.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
**MoRight** is a novel unified framework designed to advance the state of the art in [[accelerating-training-of-autoregressive-video-generation-models-via-local-optimi|Video Generation]] and [[moright-motion-control-done-right|Motion Control]]. The framework specifically addresses the persistent challenges of maintaining physical plausibility and user agency when generating motion-driven video content.

## The Problem: Entanglement and Lack of Causality

Current methodologies in [[computer-vision|Computer Vision]] often suffer from two critical limitations when handling user-specified actions:
...
By modeling the relationship between active and passive motion, MoRight enables two revolutionary modes of [[artificial-intelligence-and-the-structure-of-mathematics|Artificial Intelligence]] inference:
