...
dc.title: "CBM-Dual: A 65-nm Fully Connected Chaotic Boltzmann Machine Processor for Dual Function Simulated Annealing and Reservoir Computing"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/cbm-dual-a-65-nm-fully-connected-chaotic-boltzmann-machine-processor-for-dual-fu.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
**CBM-Dual** is a groundbreaking silicon-proven [[Digital Dynamics Processor]] (CDP) designed to bridge the gap between optimization and temporal pattern recognition. Fabricated using a 65-nm process, it represents the first hardware architecture capable of supporting both [[Simulated Annealing]] (SA) and [[recurrent-quantum-feature-maps-for-reservoir-computing|Reservoir Computing]] (RC) within a single unified framework.
