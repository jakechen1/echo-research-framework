...
dc.title: "Unmasking Hallucinations: A Causal Graph-Attention Perspective on Factual Reliability in Large Language Models"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/unmasking-hallucinations-a-causal-graph-attention-perspective-on-factual-reliabi.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The efficacy of the GCAN framework was tested against standard benchmarks, including [[TruthfulQA]] and [[HotpotQA]]. The results demonstrated significant improvements over standard [[contradictions-in-context-challenges-for-retrieval-augmented-generation-in-healt|Retrieval-Augmented Generation]] (RAG) models:
