...
dc.title: "Generation time in a discrete epidemic model with asymptomatic carriers: beyond geometric waiting times"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/generation-time-in-a-discrete-epidemic-model-with-asymptomatic-carriers-beyond-g.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
This research introduces a sophisticated approach to calculating the intervals between successive cases in a transmission chain of [[Infectious Diseases]]. Moving away from traditional [[Markovian processes]] that rely on simplified geometric waiting times, the paper presents a non-Markovian, discrete-time [[analysis-of-non-pharmaceutical-interventions-with-sir-epidemic-models-decreasing|Epidemic Model]] capable of accounting for complex transmission dynamics involving asymptomatic carriers.
...
The researchers validated the model using several data-driven epidemic scenarios. To represent the waiting times accurately, they employed [[Discrete Weibull Distributions]]. The analysis of various diseases demonstrated that, with the exception of [[Measles]], most investigated pathogens exhibit moderate variability in their respective generation time distributions. This findings suggest that the model provides a more robust framework for [[Epidemiology]] than models assuming constant or geometrically distributed intervals.