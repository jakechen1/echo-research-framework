...
dc.title: "XMark: Reliable Multi-Bit Watermarking for LLM-Generated Texts"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/xmark-reliable-multi-bit-watermarking-for-llm-generated-texts.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
1. **Advanced Encoder:** The XMark encoder is engineered to produce a less distorted [[Logit Distribution]] during the token generation process. By minimizing the impact on the model's original output probabilities, XMark preserves the semantic and grammatical integrity of the text, ensuring the watermark remains imperceptible.
