...
dc.title: "ArrowFlow: Hierarchical Machine Learning in the Space of Permutations"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/arrowflow-hierarchical-machine-learning-in-the-space-of-permutations.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
Experimental evaluations across [[machine-learning|UCI Machine Learning Repository]] benchmarks, MNIST, and [[Gene expression analysis]] (TCGA) show that ArrowFlow is highly competitive with gradient-based baselines. Notably, it outperformed baselines on the Iris dataset (2.7% vs. 3.3% error).
