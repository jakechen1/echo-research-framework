...
dc.title: "Data Attribution in Adaptive Learning"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/data-attribution-in-adaptive-learning.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
However, modern [[artificial-intelligence-and-the-structure-of-mathematics|Artificial Intelligence]] training pipelines, including [[deepsearch-overcome-the-bottleneck-of-reinforcement-learning-with-verifiable-rew|Reinforcement Learning]], [[Online Bandits]], and the post-training phases of [[from-large-language-model-predicates-to-logic-tensor-networks-neurosymbolic-offe|Large Language Model]] (LLM) development, operate in **adaptive settings**. In these environments, a single training observation performs two simultaneous roles:
