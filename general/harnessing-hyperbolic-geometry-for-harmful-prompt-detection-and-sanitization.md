...
dc.title: "Harnessing Hyperbolic Geometry for Harmful Prompt Detection and Sanitization"
dc.creator: wiki-pipeline
dc.date: 2024-05-23
dc.type: Text
dc.format: text/markdown
dc.identifier: general/harnessing-hyperbolic-geometry-for-harmful-prompt-detection-and-sanitization.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The research paper "Harnessing Hyperbolic Geometry for Harmful Prompt Detection and Sanitization" addresses a critical security vulnerability in [[aligned-vector-quantization-for-edge-cloud-collabrative-vision-language-models|Vision-Language Models]] (VLMs): the susceptibility to malicious prompts designed to trigger unsafe or harmful content. While VLMs are foundational for tasks like image synthesis and retrieval, their ability to align textual and visual information makes them targets for [[explainability-guided-adversarial-attacks-on-transformer-based-malware-detectors|Adversarial Attacks]] that bypass traditional safety mechanisms.
