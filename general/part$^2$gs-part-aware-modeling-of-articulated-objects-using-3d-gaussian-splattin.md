...
dc.title: "Part$^{2}$GS: Part-aware Modeling of Articulated Objects using 3D Gaussian Splatting"
dc.creator: wiki-pipeline
dc.date: 2024-05-24
dc.type: Text
dc.format: text/markdown
dc.identifier: general/part$^2$gs-part-aware-modeling-of-articulated-objects-using-3d-gaussian-splattin.md
dc.language: en
dc.rights: CC-BY-4.0
---
