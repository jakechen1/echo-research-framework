...
dc.title: "Splats under Pressure: Exploring Performance-Energy Trade-offs in Real-Time 3D Gaussian Splatting under Constrained GPU Budgets"
dc.creator: wiki-pipeline
dc.date: 2024-05-22
dc.type: Text
dc.format: text/markdown
dc.identifier: general/splats-under-pressure-exploring-performance-energy-trade-offs-in-real-time-3d-ga.md
dc.language: en
dc.rights: CC-BY-4.0
---
