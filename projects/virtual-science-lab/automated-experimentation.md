...
*   **Foundation Models for Science:** The application of large-scale [[Transformer]] architectures trained on massive corpuses of experimental data to provide "zero-shot" capabilities for experiment design.
