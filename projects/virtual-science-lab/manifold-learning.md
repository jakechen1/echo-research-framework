...
*   **Neural Manifold Decoders:** The concept of a "Neural Manifold Decoder" has emerged in the context of advanced [[Brain-Computer Interfaces]] (BCI). As seen in the work by [[Haitao Yu et al., 2025]], representation learning can be used to decode complex biological stimuli (such as acupuncture-induced neural activity) by mapping high-dimensional neural populations onto a low-dimensional latent manifold that captures the "neural code" of the stimulus.
