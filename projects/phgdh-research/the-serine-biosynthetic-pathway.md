---
title: "The Serine Biosynthetic Pathway"
created: 2026-04-11
category: biology
tags: [metabolism, biochemistry, glycolysis, PHGDH, amino acid synthesis, oncology, neurology]
source_urls:
...
dc.title: "The Serine Biosynthetic Pathway"
dc.creator: wiki-dashboard
dc.date: 2026-04-11
dc.type: Text
dc.format: text/markdown
dc.identifier: projects/phgdh-research/the-serine-biosynthetic-pathway.md
dc.language: en
dc.rights: CC-BY-4.0
---
...
The serine biosynthetic pathway is not an isolated metabolic loop; it acts as a metabolic "hub" that influences several vital cellular functions.
...
The regulation of the serine pathway is primarily exerted through the allosteric control of **PHGDH**. As the first enzyme in the pathway, PHGDHD is subject to **feedback inhibition** by the end-product, L-serine. When intracellular serine concentrations reach a certain threshold, serine binds to the regulatory domain of PHGDH, inducing a conformational change that reduces its catalytic activity. This prevents the unnecessary depletion of glycolytic intermediates when serine levels are sufficient.

Recent research (as of 2025) has also highlighted the role of post-translational modifications (PTMs), such as phosphorylation and acetylation, in modulating PHGDH activity in response to insulin signaling and nutrient sensing via the **mTORC1** pathway.

## Clinical Implications: Oncology and Neurodegeneration

### Cancer Metabolism and "Serine Addiction"
One of the most significant findings in the last decade of metabolic research is the "addiction" of many cancer cells to the serine biosynthetic pathway. In various malignancies—particularly than NSCLC (Non-Small Cell Lung Cancer) and melanoma—PHGDH is frequently overexpressed or amplified. 

By upregulating the serine pathway, cancer cells can:
1. Support rapid DNA replication for proliferation.
2. Maintain high levels of GSH to evade apoptosis caused by oxidative stress.
 and 3. Divert carbon from glycolysis to support the biosynthesis of other essential macromolecules.
...
Despite significant progress, several challenges remain in the field of serine metabolism:

* **Tissue Specificity:** It remains difficult to distinguish between the metabolic requirements of healthy neurons versus glial cells, or between tumor cells and the surrounding stroma, using current metabolic imaging techniques.
* **Pharmacological Selectivity:** Developing PHGDH inhibitors that are potent enough to inhibit cancer cell growth without disrupting the essential serine supply to healthy, high-demand tissues (like the brain and immune system) is a major hurdle in drug development.
* **Isotopic Tracing Limitations:** While $^{13}\text{C}$-glucose tracing has revolutionized our understanding of flux, the development of real-time, *in vivo* metabolic flux analysis in human subjects is still in its infancy.

Future research is expected to focus on the integration of **single-cell metabolomics** and the identification of metabolic "vulnerabilities" in the tumor microenvironment. Furthermore, investigating the link between the serine pathway and the gut microbiome—which can also influence systemic amino acid availability—represents a burgeoning frontier in metabolic medicine.

## References
1. Zhang C et al., 2023. Wild-type IDH1 maintains NSCLC stemness and chemoresistance through activation of the serine biosynthetic pathway. Sci Transl Med. [https://pubmed.ncbi.nlm.nih.gov/38091408/](https://pubmed.ncbi.nlm.nih.gov/38091408/)
2. Shi Q et al., 2022. Increased glucose metabolism in TAMs fuels O-GlcNAcylation of lysosomal Cathepsin B to promote cancer metastasis and chemoresistance. Cancer Cell. [https://pubmed.ncbi.nlm.nih.gov/36084651/](https://pubmed.ncbi.nlm.nih.gov/36084651/)
3. Amelio I et al., 2014. Serine and glycine metabolism in cancer. Trends Biochem Sci. [https://pubmed.ncbi.nlm.nih.gov/24657017/](https://pubmed.ncbi.nlm.nih.gov/24657017/)
4. Yawen Zhang et al., 2022. Ailanthone Inhibits Proliferation, Migration and Invasion of Osteosarcoma Cells by Downregulating the Serine Biosynthetic Pathway [https://doi.org/10.3389/fonc.2022.842406](https://doi.org/10.3389/fonc.2022.842406)
5. Laurie K. Svoboda et al., 2018. Menin regulates the serine biosynthetic pathway in Ewing sarcoma [https://doi.org/10.1002/path.5085](https://doi.org/10.1002/path.5085)
